...
#include "ui/text/text.h" // TextWithEntities, Text::MarkedContext, Text::String - like
                           // message_bubble.h, this file relies on lib_ui's shared PCH
                           // for these upstream; zkgram has none, so it is explicit here.
