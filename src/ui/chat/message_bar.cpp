...
// styles/style_chat_helpers.h dropped: only historyReplyHeight/MessageBar/
// defaultMessageBar are needed from it, all inlined as real literals/
// declarations in zkgram_chat_style_stub.style instead (see that file's
// own comments) - chat_helpers.style pulls in boxes/premium/calls for the
// rest.
