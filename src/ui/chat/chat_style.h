...
// style_iv.h dropped: nothing in this file uses any st::iv* icon/button
// INSTANCE (Instant View article reader, a feature zkgram does not have),
// and iv.style pulls in chat_helpers.style's much larger graph for it. The
// style::Markdown struct TYPE this file's richPageStyle field still needs
// is declared on its own in zkgram_chat_style_stub.style instead - see
// that file's own comment.
#include "styles/style_basic.h"
#include "styles/style_zkgram_chat_style_stub.h"
