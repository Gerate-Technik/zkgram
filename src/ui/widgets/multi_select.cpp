...
// Adapted for zkgram: real tdesktop's multi_select.cpp also includes
// "lang/lang_keys.h", unused here (no tr::lng_* calls in this file at
// all) - dropped rather than vendoring the whole lang/ codegen pipeline
// for a dead include.
