...
#include "ui/text/text.h" // TextParseOptions, TextParse* flags

// styles/style_window.h dropped: only st::columnMaximalWidthLeft is needed
// from it, inlined as a real literal in zkgram_chat_style_stub.style
// instead (window.style pulls in chat_helpers/boxes.style for the rest).
